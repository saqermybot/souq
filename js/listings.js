...
async function loadListings(reset=true){
  ...
  snap.forEach(ds=>{
    ...
    card.innerHTML = `
      <img class="cardCover" src="${img}" alt="" />
      <div class="p">
        ...
        <button class="secondary btnView">عرض</button>
      </div>
    `;

    // ✅ فتح التفاصيل عند الضغط على الصورة أو زر عرض
    card.querySelector(".cardCover").onclick = () => openDetails(id, data);
    card.querySelector(".btnView").onclick = () => openDetails(id, data);
